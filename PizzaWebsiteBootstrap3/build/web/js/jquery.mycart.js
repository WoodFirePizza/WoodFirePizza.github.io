  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-shopping-cart"></span> My Basket</h4>' +
        '</div>' +
    ...
    var drawTable = function(){
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '</tr>'
        : '<div class="alert alert-danger" role="alert" id="' + idEmptyCartMessage + '">Your basket is empty</div>'
      );

      var discountPrice = options.getDiscountPrice(products, ProductManager.getTotalPrice(), ProductManager.getTotalQuantity());
      if(products.length && discount !== null) {
        $cartTable.append(
          '<tr style="color: red">' +
          '<td></td>' +
    ...
    */
    ...
    $("." + classCheckoutCart).click(function(){
      ...
      window.open("checkoutDetails.html");
      /*updateCart();
