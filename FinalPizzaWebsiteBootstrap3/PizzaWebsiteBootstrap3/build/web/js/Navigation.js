    ...
    navHtml += '<nav class="navbar navbar-default main-nav">';
        navHtml += '<div class="container-fluid">';
          ...
          navHtml += '<div class="navbar-header">';
            ...
            navHtml += '<a id="mobileBasket" href="#" class ="nav-link" data-toggle="modal" data-target="#basketModal" id="myBasket"><i class="fa fa-shopping-basket" aria-hidden="true"></i></a>'; 
          ...
          navHtml += '<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">';
            navHtml += '<ul class="nav navbar-nav">';
                ...
                navHtml += '<li><a class="navItem" id="desktopHide" href="#"data-toggle="modal" data-target="#loginModal" ><img src="Res/Icons/002-person.png" alt=""/>           Sign in / Sign Up</a></li>';
