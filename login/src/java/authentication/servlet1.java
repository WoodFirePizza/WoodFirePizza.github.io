...
public class servlet1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>" + doesItWork + "</h1>");
                    
            out.println("<h1> ID: " + jwt +"</h1>");       
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            String typedPassword = request.getParameter("userpass");

            APILogin connection = new APILogin(typedUsername, typedPassword);
            String string = connection.getResponseString();
